...
cd /home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/79cae2a4-3f3d-4b7c-b0d2-fc19a63093e9
...
create_yml () {
  ...
  (
    umask 077
    echo -e "host: $host\nport: $port\npassword: $password\ndisplay: $display\nwebsocket: $websocket\nspassword: $spassword\nvnc_connection_file: $vnc_connection_file\nstaging_folder: $staging_folder" > "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/79cae2a4-3f3d-4b7c-b0d2-fc19a63093e9/connection.yml"
  )
}
...
clean_up () {
  echo "Cleaning up..."
  [[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/79cae2a4-3f3d-4b7c-b0d2-fc19a63093e9/clean.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/79cae2a4-3f3d-4b7c-b0d2-fc19a63093e9/clean.sh"
...
[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/79cae2a4-3f3d-4b7c-b0d2-fc19a63093e9/before.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/79cae2a4-3f3d-4b7c-b0d2-fc19a63093e9/before.sh"


echo "Script starting..."
DISPLAY=:${display} "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/79cae2a4-3f3d-4b7c-b0d2-fc19a63093e9/script.sh" &
SCRIPT_PID=$!

[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/79cae2a4-3f3d-4b7c-b0d2-fc19a63093e9/after.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/79cae2a4-3f3d-4b7c-b0d2-fc19a63093e9/after.sh"
