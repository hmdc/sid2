...
cd /home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0c4af8b9-d7cd-4eac-81a2-5d76d277c1e4
...
create_yml () {
  ...
  (
    umask 077
    echo -e "host: $host\nport: $port\npassword: $password\ndisplay: $display\nwebsocket: $websocket\nspassword: $spassword\nvnc_connection_file: $vnc_connection_file\nstaging_folder: $staging_folder" > "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0c4af8b9-d7cd-4eac-81a2-5d76d277c1e4/connection.yml"
  )
}
...
clean_up () {
  echo "Cleaning up..."
  [[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0c4af8b9-d7cd-4eac-81a2-5d76d277c1e4/clean.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0c4af8b9-d7cd-4eac-81a2-5d76d277c1e4/clean.sh"
...
[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0c4af8b9-d7cd-4eac-81a2-5d76d277c1e4/before.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0c4af8b9-d7cd-4eac-81a2-5d76d277c1e4/before.sh"


echo "Script starting..."
DISPLAY=:${display} "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0c4af8b9-d7cd-4eac-81a2-5d76d277c1e4/script.sh" &
SCRIPT_PID=$!

[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0c4af8b9-d7cd-4eac-81a2-5d76d277c1e4/after.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0c4af8b9-d7cd-4eac-81a2-5d76d277c1e4/after.sh"
