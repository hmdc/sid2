...
cd /home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/4af697a2-8688-4d9d-b06c-33d4b4566b39
...
create_yml () {
  ...
  (
    umask 077
    echo -e "host: $host\nport: $port\npassword: $password\ndisplay: $display\nwebsocket: $websocket\nspassword: $spassword\nvnc_connection_file: $vnc_connection_file\nstaging_folder: $staging_folder" > "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/4af697a2-8688-4d9d-b06c-33d4b4566b39/connection.yml"
  )
}
...
clean_up () {
  echo "Cleaning up..."
  [[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/4af697a2-8688-4d9d-b06c-33d4b4566b39/clean.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/4af697a2-8688-4d9d-b06c-33d4b4566b39/clean.sh"
...
[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/4af697a2-8688-4d9d-b06c-33d4b4566b39/before.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/4af697a2-8688-4d9d-b06c-33d4b4566b39/before.sh"


echo "Script starting..."
DISPLAY=:${display} "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/4af697a2-8688-4d9d-b06c-33d4b4566b39/script.sh" &
SCRIPT_PID=$!

[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/4af697a2-8688-4d9d-b06c-33d4b4566b39/after.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/4af697a2-8688-4d9d-b06c-33d4b4566b39/after.sh"
