...
cd /home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/2962cca6-e491-4ba4-9d6a-e4bc89f4aa00
...
create_yml () {
  ...
  (
    umask 077
    echo -e "host: $host\nport: $port\npassword: $password\ndisplay: $display\nwebsocket: $websocket\nspassword: $spassword\nvnc_connection_file: $vnc_connection_file\nstaging_folder: $staging_folder" > "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/2962cca6-e491-4ba4-9d6a-e4bc89f4aa00/connection.yml"
  )
}
...
clean_up () {
  echo "Cleaning up..."
  [[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/2962cca6-e491-4ba4-9d6a-e4bc89f4aa00/clean.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/2962cca6-e491-4ba4-9d6a-e4bc89f4aa00/clean.sh"
...
[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/2962cca6-e491-4ba4-9d6a-e4bc89f4aa00/before.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/2962cca6-e491-4ba4-9d6a-e4bc89f4aa00/before.sh"


echo "Script starting..."
DISPLAY=:${display} "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/2962cca6-e491-4ba4-9d6a-e4bc89f4aa00/script.sh" &
SCRIPT_PID=$!

[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/2962cca6-e491-4ba4-9d6a-e4bc89f4aa00/after.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/2962cca6-e491-4ba4-9d6a-e4bc89f4aa00/after.sh"
