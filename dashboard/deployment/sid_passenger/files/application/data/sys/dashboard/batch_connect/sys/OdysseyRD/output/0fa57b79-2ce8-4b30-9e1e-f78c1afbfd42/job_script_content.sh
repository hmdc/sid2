...
cd /home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0fa57b79-2ce8-4b30-9e1e-f78c1afbfd42
...
create_yml () {
  ...
  (
    umask 077
    echo -e "host: $host\nport: $port\npassword: $password\ndisplay: $display\nwebsocket: $websocket\nspassword: $spassword\nvnc_connection_file: $vnc_connection_file\nstaging_folder: $staging_folder" > "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0fa57b79-2ce8-4b30-9e1e-f78c1afbfd42/connection.yml"
  )
}
...
clean_up () {
  echo "Cleaning up..."
  [[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0fa57b79-2ce8-4b30-9e1e-f78c1afbfd42/clean.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0fa57b79-2ce8-4b30-9e1e-f78c1afbfd42/clean.sh"
...
[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0fa57b79-2ce8-4b30-9e1e-f78c1afbfd42/before.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0fa57b79-2ce8-4b30-9e1e-f78c1afbfd42/before.sh"


echo "Script starting..."
DISPLAY=:${display} "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0fa57b79-2ce8-4b30-9e1e-f78c1afbfd42/script.sh" &
SCRIPT_PID=$!

[[ -e "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0fa57b79-2ce8-4b30-9e1e-f78c1afbfd42/after.sh" ]] && source "/home/ood/ondemand/data/sys/dashboard/batch_connect/sys/OdysseyRD/output/0fa57b79-2ce8-4b30-9e1e-f78c1afbfd42/after.sh"
